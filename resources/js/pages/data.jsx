        ...
        <div className="mx-auto max-w-lg p-6 text-black">
            ...
            >
                ...
                <div>
                    ...
                    <input type="number" name="tds" defaultValue={targetTds ?? ''} className="w-full rounded-md border px-3 py-2" />
                </div>
                <div>
                    <label className="mb-1 block text-sm font-medium">🎯 Target Suhu Ruangan</label>
                    <input type="number" name="suhu" defaultValue={targetSuhuRuangan ?? ''} className="w-full rounded-md border px-3 py-2" />
                </div>
                <div>
                    <label className="mb-1 block text-sm font-medium">🎯 Target Kelembapan</label>
                    <input type="number" name="kelembapan" defaultValue={targetKelembapan ?? ''} className="w-full rounded-md border px-3 py-2" />
                </div>
                <div>
                    <label className="mb-1 block text-sm font-medium">🎯 Target Suhu Air</label>
                    <input type="number" name="suhu_air" defaultValue={targetSuhuAir ?? ''} className="w-full rounded-md border px-3 py-2" />
                </div>
